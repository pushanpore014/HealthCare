...
public class AppointmentController {
	...
	@Autowired
	private DiagnosticTestService dtservice;
	@Autowired
	private DiagnosticCenterService dcservice;

	public AppointmentController(AppointmentService aservice, PatientService pservice, DiagnosticTestService dtservice, DiagnosticCenterService dcservice) {
